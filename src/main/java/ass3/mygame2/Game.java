...
//        game title should be appear in first statement of game start
        System.out.println("Hi and Get READY tO pLAY zUULu");
        System.out.println("Help the player to get out from castle ");
        System.out.println("Dont Forget to keep check on inventory ");
...
//        A key to quit the game
    ...
    private void dropItem(Command command) {
        if (!command.hasSecondWord()) {
            ...
            System.out.println("What are you going to drop sir?");
            return;
        }
    ...
    private void useItem(Command command) // use key
    {
        ...
        if (!command.hasThirdWord()) {
            // if there is no second word, we don't know where to go...
            System.out.println("Whats Reason");
            return;
        }
...
//            System.out.println("You just used the third command" + currentQItem.getName());
            ...
            System.out.println("As you ordered : here is your new action :  " + itemFromCommand + " " + itemTrainingCommand  );
